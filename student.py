...
class Student:
    def __init__(self,root):
        ...
        # first image
        img = Image.open(r"img\lyallpurkhalsa.jpg")
        ...
        # third image
        img2 = Image.open(r"img\khalsa.jpg")
        img2 = img2.resize((457, 120), Image.ANTIALIAS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        f_lbl = Label(self.root, image=self.photoimg2)
        f_lbl.place(x=911, y=0, width=457, height=120)
        ...
        bg_img.place(x=0, y=120, width=1366, height=710)

        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",32,"bold"),bg="white",fg="green")
        ...
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student's Details",font=("times new roman",11,"bold"))
        ...
        current_course_frame.place(x=3, y=130, width=625, height=100)
#Department
...
#Semester
        ...
        semester_combo["values"]=("Select Semester","I","II","III","IV","V","VI","VII","VIII","IX","X")
...
#Student Information
        ...
        class_student_frame.place(x=3, y=230, width=625, height=350)
#studentID
...
#class division
        ...
        class_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",11,"bold"),width=15,state="readonly")
        class_combo["values"]=("A","B","C","D")
        class_combo.current(0)
        class_combo.grid(row=1,column=1,padx=10,pady=5,sticky=W)
#Rollnumber
        rollnumber_label=Label(class_student_frame,text="Rollnumber",font=("times new roman",11,"bold"),bg="white")
        rollnumber_label.grid(row=1,column=2,padx=10,pady=5,sticky=W)

        rollnumber_entry=ttk.Entry(class_student_frame,textvariable=self.var_roll,width=20,font=("times new roman",10,"bold"))
...
#Gender
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,font=("times new roman",11,"bold"),width=15,state="readonly")
...
#phonenumber
        phonenumber_label=Label(class_student_frame,text="Phone Number",font=("times new roman",11,"bold"),bg="white")
        phonenumber_label.grid(row=3,column=2,padx=10,pady=5,sticky=W)

        phonenumber_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=20,font=("times new roman",10,"bold"))
...
#buttons frame
        ...
        btn_frame.place(x=0,y=190,width=620,height=30) 

        save_btn=Button(btn_frame,text="SAVE",command=self.add_data,width=16,font=("Times New Roman",11,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="UPDATE",command=self.update_data,width=16,font=("Times New Roman",11,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="DELETE",command=self.delete_data,width=16,font=("Times New Roman",11,"bold"),bg="blue",fg="white")
        ...
        btn_frame1.place(x=0,y=220,width=620,height=30)

        take_photo_btn=Button(btn_frame1,text="TAKE PHOTO SAMPLE",command=self.generate_dataset,width=33,font=("Times New Roman",11,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,text="UPDATE PHOTO SAMPLE",width=33,font=("Times New Roman",11,"bold"),bg="blue",fg="white")
        ...
        search_frame.place(x=3, y=130, width=640, height=65)
        ...
        search_combo["values"]=("Select","Roll_Number","Phone_Number")
        ...
        table_frame.place(x=3, y=200, width=640, height=300)

        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","roll","gender","div","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                   conn=mysql.connector.connect(host="localhost",username="root",password="",database="test")
                   my_cursor=conn.cursor()
                   my_cursor.execute("update student set Dep=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Roll_number=%s,Gender=%s,Division=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_Id=%s",(
